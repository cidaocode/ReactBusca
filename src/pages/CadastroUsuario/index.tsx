...
function CadastroUsuario() {
    ...
    function casdastrarUsuario(event: any) {

        event.preventDefault();
        // formData e um objeto que vc vai acrescentando 
        ...
        api.post("users", formdata).then((response) => {
            ...
            alert("Usuario crado com sucesso!!!😊😘😍 ")
        }).catch((error) => {
            console.log(error)
        })
        ...
        <main className="main_cadastro">
            <div className="container container_cad">
                <div className="cad_conteudo">
                    <h1>Cadastro</h1>
                    <hr />
                    <form onSubmit={casdastrarUsuario} className="cad_formulario" method="POST">
